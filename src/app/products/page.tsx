...
const products = [
  ...
  },
  {
    ...
    description: "An intelligent project management assistant powered by AI that helps teams plan, execute, and deliver projects more efficiently. From automated task scheduling and risk prediction to real-time status reporting and resource optimization, our AI PM assistant keeps your projects on track and on budget.",
    features: [
