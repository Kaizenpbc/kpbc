        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              AI Resume <span className="gradient-text">Writing</span>
            </h1>
          ...
          <AnimatedSection>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-muted leading-relaxed text-lg mb-4">
                In today&apos;s competitive job market, your resume has just seconds to make an impression. Our AI Resume Writing platform analyzes job postings, understands industry expectations, and crafts tailored resumes that highlight your strengths in the language hiring managers and ATS systems are looking for.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="text-muted max-w-2xl mx-auto mb-8">
              Contact us to learn how our AI Resume Writing platform can help you stand out and get noticed by the right employers.
            </p>
            <Link
              href="/contact"
